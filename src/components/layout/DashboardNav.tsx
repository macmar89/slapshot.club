      ...
      {dashboardConfig.sidebarNav.map((item) => {
        ...
        return (
          <Link
            key={item.href}
            href={href as any}
            className="flex gap-3 px-4 py-3 rounded-app text-white/70 hover:text-white hover:bg-white/10 transition-colors text-sm font-medium uppercase tracking-wider"
          >
