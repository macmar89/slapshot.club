...
export function HockeyLoader({ className, text }: HockeyLoaderProps) {
  ...
  return (
    <div
      className={cn(
        'fixed inset-0 z-[100] bg-black overflow-hidden flex items-center justify-center',
        className,
      )}
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 p-12 rounded-app border border-white/10 bg-black/40 backdrop-blur-2xl shadow-[0_0_50px_-12px_rgba(234,179,8,0.2)] max-w-md w-full mx-4">
