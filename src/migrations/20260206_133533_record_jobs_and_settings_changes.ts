...
DO $$ BEGIN
  ...
  DROP INDEX IF EXISTS "users_stats_stats_total_points_idx";
  ...
  ALTER TABLE "general_settings" ADD COLUMN IF NOT EXISTS "cron_settings_update_matches_enabled" boolean DEFAULT true;
  DO $$ BEGIN
